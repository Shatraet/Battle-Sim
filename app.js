...
const playerOneAttack = (subtract, missCount, attackName) => {
  ...
  if (randomNumber !== 1) {
    ...
    gameStateText.innerText = `Jesus used ${attackName}... But it missed!`;
    intervalFunction();
  }
};
...
attackOne.addEventListener("click", () => playerOneAttack(12, 18, "Crusifiction"));
attackTwo.addEventListener("click", () =>
  playerOneAttack(20, 8, "Water To Wine")
);
attackThree.addEventListener("click", () =>
  playerOneAttack(24, 4, "Holy Smite")
);
attackFour.addEventListener("click", () =>
  playerOneAttack(29, 2, "Christianity")
);
